...
LICENSE:
    Copyright (C) 2015 Peter Fleury //Modified by Kutukov Pavel 2016-2020//, GNU General Public License Version 3
...
#if ENABLE_UART_EXTENSIONS
/************************************************************************/
/* Disables all bits enabled by uart_init() in UART control registers   */
/************************************************************************/
